...
$\mathbf{\parallel a\parallel*\parallel b\parallel}$=


$(\sqrt{\sum \mathbf{a}^2})*(\sqrt{\sum \mathbf{b}^2})$ = $\sqrt{1^2+1^2+1^2+1^2+0^2} * \sqrt{1^2+0^2+1^2+2^2+1^2}$ = $\sqrt{4} * \sqrt{7}$ = $\sqrt{28}$   
