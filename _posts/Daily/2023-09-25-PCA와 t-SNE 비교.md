...
plt.show()
```
![정의](../../assets/images/post_images/2023-09-25-(01)/Figure1.png){: .align-center  width="30%" height="30%"}
...
plt.show()
```
![정의](../../assets/images/post_images/2023-09-25-(01)/Figure2.png){: .align-center  width="30%" height="30%"}
Apply t-SNE
...
plt.show()
```
![정의](../../assets/images/post_images/2023-09-25-(01)/Figure3.png){: .align-center  width="30%" height="30%"}
## 5. 생각해보기
### Q1. 
